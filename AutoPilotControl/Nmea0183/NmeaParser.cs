...
namespace Iot.Device.Nmea0183
{
    ...
    public delegate void PositionUpdate(GeographicPosition position, Angle track, double speed);
    ...
    public class NmeaParser : NmeaSinkAndSource, IDisposable
    {
        ...
        private void Parser()
        {
            while (_cancellationTokenSource != null && !_cancellationTokenSource.IsCancellationRequested)
            {
                ...
                {
                    FireOnParserError(NmeaError.PortClosed);
                    continue;
                }
        ...
        private void Sender()
        {
            while (_cancellationTokenSource != null && !_cancellationTokenSource.IsCancellationRequested)
            {
                ...
                {
	                NmeaSentence sentenceToSend = (NmeaSentence)_outQueue.Dequeue();
