...
namespace Iot.Device.Nmea0183
{
    ...
    public abstract class NmeaSinkAndSource : IDisposable
    {
        ...
        /// </summary>
        public virtual event Action<NmeaSinkAndSource, NmeaError> OnParserError;
        ...
        protected void FireOnParserError(NmeaError error)
        {
            OnParserError?.Invoke(this, error);
        }
        ...
        public virtual void SendSentences(IEnumerable sentencesToSend)
        {
            foreach (NmeaSentence sentence in sentencesToSend)
            {
